...
const warningVariant = {
  warning: "bg-warning hover:bg-warning/90 active:bg-warning/70 text-white",
...
const infoVariant = {
  info: "bg-info hover:bg-info/90 active:bg-info/70 text-white",
...
const darkVariant = {
  dark: "bg-dark hover:bg-dark/90 active:bg-dark/70 text-white",
